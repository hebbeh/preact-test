...
var header_Header = function Header() {
	return Object(preact_min["h"])(
		...
		Object(preact_min["h"])(
			...
			Object(preact_min["h"])(
				match["Link"],
				{ activeClassName: header_style_default.a.active, href: '/flowers' },
				'Flowers'
			),
			Object(preact_min["h"])(
				match["Link"],
...
// EXTERNAL MODULE: ./routes/github/style.css
var github_style = __webpack_require__("aWz5");
var github_style_default = /*#__PURE__*/__webpack_require__.n(github_style);

// CONCATENATED MODULE: ./routes/github/index.js


function _objectDestructuringEmpty(obj) { if (obj == null) throw new TypeError("Cannot destructure undefined"); }

function github__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function github__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function github__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var github_Github = function (_Component) {
	github__inherits(Github, _Component);

	function Github() {
		var _temp, _this, _ret;

		github__classCallCheck(this, Github);

		for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
			args[_key] = arguments[_key];
		}

		return _ret = (_temp = (_this = github__possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = {
			username: '',
			followers: null
		}, _this.fetchUser = function () {
			fetch('https://api.github.com/users/' + _this.state.username).then(function (response) {
				return response.json();
			}).then(function (user) {
				return _this.setState({ followers: user.followers });
			});
		}, _this.setUsername = function (e) {
			_this.setState({ username: e.target.value });
		}, _temp), github__possibleConstructorReturn(_this, _ret);
	}

	Github.prototype.render = function render(_ref, _ref2) {
		...
		return Object(preact_min["h"])(
			'div',
			{ 'class': github_style_default.a.container },
			_ref3,
...
// EXTERNAL MODULE: ./routes/flower/style.css
var flower_style = __webpack_require__("rpDW");
var flower_style_default = /*#__PURE__*/__webpack_require__.n(flower_style);

// CONCATENATED MODULE: ./routes/flower/index.js




var flower__ref = Object(preact_min["h"])(
	'h1',
	null,
	'Flower'
);

var flower_Flower = function Flower() {
	return Object(preact_min["h"])(
		'div',
		{ 'class': flower_style_default.a.root },
		flower__ref
	);
};

/* harmony default export */ var flower = (flower_Flower);
...
var _ref4 = Object(preact_min["h"])(flower, { path: '/flowers' });

var _ref5 = Object(preact_min["h"])(profile_Profile, { path: '/profile/:user' });

var _ref6 = Object(preact_min["h"])(github_Github, { path: '/github' });
...
// removed by extract-text-webpack-plugin
module.exports = {"container":"container__3jKSX"};
...
// removed by extract-text-webpack-plugin
module.exports = {"root":"root__2TULl"};
